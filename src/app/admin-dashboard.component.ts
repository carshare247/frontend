  ...
  template: `
      <main class="admin-page">
        <header class="admin-head">
          <div>
            <p class="eyebrow">CARSHARE247 / CONTROL ROOM</p>
        ...
        <div style="margin-bottom:12px">
          ...
          <button class="btn" [class.active]="tab==='verifications'" (click)="tab='verifications'; loadVerifications()">Didit verification</button>
        </div>
